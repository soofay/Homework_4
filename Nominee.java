...
public class Nominee {
    ...
    public float getNomineeAwardQuantitySum() {
    ...
    public boolean belowAwardQuantityLimit(){
        return this.nomineeAwardQuantitySum < nomineeAwardQuantityLimit;
    }

    public boolean belowAwardAmountLimit() {
        return  this.nomineeAwardAmountSum < nomineeAwardAmountLimit;
    }
